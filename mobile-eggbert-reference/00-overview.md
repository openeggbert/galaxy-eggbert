...
| `09-open-questions.md` | Open questions for the eventual 3D mapping design | **Partially resolved, terrain-rendering answer corrected 2026-07-06** — the `ObjectType` render-mode question still stands, but "all 441 terrain tiles are `UniformCube`" was found wrong at scale; see `15-3d-render-mapping-design.md` §10 |
