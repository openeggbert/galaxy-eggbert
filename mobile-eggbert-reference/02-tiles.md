...
| ![icon330](images/tile-full-330.png) | 330 | `Teleport1` | interactive — **Billboard** (§10.2): cone/pyramid beacon post with colored indicator dots + emblem letter | no | no | 11/78 files — solid pillar |
| ![icon331](images/tile-full-331.png) | 331 | `Teleport2` | interactive — **Billboard** (§10.2): cone/pyramid beacon post with colored indicator dots + emblem letter | no | no | 6/78 files — solid pillar |
| ![icon332](images/tile-full-332.png) | 332 | `Teleport3` | interactive — **Billboard** (§10.2): cone/pyramid beacon post with colored indicator dots + emblem letter | no | no | 4/78 files — solid pillar |
| ![icon333](images/tile-full-333.png) | 333 | `Teleport4` | interactive — **Billboard** (§10.2): cone/pyramid beacon post with colored indicator dots + emblem letter | no | no | 3/78 files — solid pillar |
