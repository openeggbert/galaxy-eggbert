...
**Status: COMPLETE for cataloging (icon/name/passability/usage); render-mode labeling pass added
2026-07-06.** All 441 addressable icon IDs (0–440) are accounted for — 314 with a full 64×64 image
crop (every icon that is either already named/behavioral in `BlockTypes.hpp`, or confirmed used in
at least one of the 78 real level files), the remaining 127 unused/unnamed icons listed compactly
by range (passability + a mechanical visual signal, not a fabricated name — see "Unused/unnamed
icons" below). Classification generated and verified 2026-07-03 (`DOC-002`); all 313 crop images
regenerated 2026-07-04 after a real grid-math bug was found (`DOC-230`, see "How these images were
generated" below). Icon 379 (`SawStopped`, a real `BlockTypes.hpp` constant actively used in code)
was found miscategorized as unnamed/unused during a 2026-07-05 independent review pass and moved
into the named table (see `DOC-273`), bringing the counts to 314/127.

**Render-mode labeling pass (2026-07-06):** following the `15-3d-render-mapping-design.md` §10
...
| ![icon30](images/tile-full-030.png) | 30 | (unnamed) | unnamed variant — **Billboard** (§10.2): yellow sign with painted numeral "1" | no | no | 10/78 files |
| ![icon31](images/tile-full-031.png) | 31 | (unnamed) | unnamed variant — **Billboard** (§10.2): yellow sign with painted numeral "2" | no | no | 4/78 files |
...
| ![icon48](images/tile-full-048.png) | 48 | (unnamed) | unnamed variant — **Billboard** (§10.2): yellow warning-triangle sign (name candidate: `WarningSign`) | no | no | 11/78 files |
...
| ![icon89](images/tile-full-089.png) | 89 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): gate/portcullis-with-counterweight mechanism (metal bar racks + hinged/chained balls) | no | no | 14/78 files |
| ![icon90](images/tile-full-090.png) | 90 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): gate/portcullis-with-counterweight mechanism (metal bar racks + hinged/chained balls) | no | no | 9/78 files |
| ![icon91](images/tile-full-091.png) | 91 | (unnamed) | `Water2` sub-frame (per `table_decor_eau2`, not `Water1`) — **special-surface** (§10.4): liquid surface sub-frame, not bulk material | yes, part of `Water2`'s 6-frame cycle | no | 25/78 files |
| ![icon92](images/tile-full-092.png) | 92 | `Water1 (base)` | decorative/swimmable — **special-surface** (§10.4): flat liquid surface with wavy top-edge silhouette, not bulk material | yes, 6 frames (92-95) | no | 38/78 files — Blupi swims when grounded |
| ![icon96](images/tile-full-096.png) | 96 | `Water2 (base)` | decorative/swimmable — **special-surface** (§10.4): flat liquid surface with wavy top-edge silhouette, not bulk material | yes, 6 frames (91, 96-98) | no | not found in scanned files — Blupi swims when grounded |
...
| ![icon110](images/tile-full-110.png) | 110 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): thin dashed wire/spark/cable line segment, exact identity unclear | no | yes | 8/78 files |
| ![icon114](images/tile-full-114.png) | 114 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): thin dashed wire/spark/cable line segment, exact identity unclear | no | yes | 7/78 files |
| ![icon118](images/tile-full-118.png) | 118 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): thin dashed wire/spark/cable line segment, exact identity unclear | no | yes | 4/78 files |
| ![icon122](images/tile-full-122.png) | 122 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): thin dashed wire/spark/cable line segment, exact identity unclear | no | yes | 1/78 files |
| ![icon126](images/tile-full-126.png) | 126 | `FanLeft (base)` | hazard — **ThinMechanical** (§10.3): ventilator with thin propeller blades on a hub, wall panel | yes, 3 frames (126-128) | no | 8/78 files — kills unless shielded |
| ![icon129](images/tile-full-129.png) | 129 | `FanRight (base)` | hazard — **ThinMechanical** (§10.3): ventilator with thin propeller blades on a hub, wall panel | yes, 3 frames (129-131) | no | 7/78 files — kills unless shielded |
...
| ![icon158](images/tile-full-158.png) | 158 | `Sp0` | **CORRECTED 2026-07-12** (was: "likely `SecretPower` value 0", an unconfirmed name-based guess) — `Decor::IsWorld()` (`Decor.cpp` ~7079-7095) proves 158-165 are hub-screen world-select markers (world 1's "locked" state; paired with 166 as its "unlocked" +8 variant, `06-doors.md`'s `AdaptDoors`), wholly unrelated to Blupi's own secret-power buffs (`SecretPower` only has 5 real values — None/Shield/Power/Cloud/Hide — confirmed directly in `def/SecretPower.hpp`, not 8). Still **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon159](images/tile-full-159.png) | 159 | `Sp1` | Hub-screen world-select marker for world 2 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon160](images/tile-full-160.png) | 160 | `Sp2` | Hub-screen world-select marker for world 3 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon161](images/tile-full-161.png) | 161 | `Sp3` | Hub-screen world-select marker for world 4 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon162](images/tile-full-162.png) | 162 | `Sp4` | Hub-screen world-select marker for world 5 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon163](images/tile-full-163.png) | 163 | `Sp5` | Hub-screen world-select marker for world 6 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon164](images/tile-full-164.png) | 164 | `Sp6` | Hub-screen world-select marker for world 7 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon165](images/tile-full-165.png) | 165 | `Sp7` | Hub-screen world-select marker for world 8 (see icon 158's corrected entry) — **Billboard** (§10.2): gold pedestal | no | yes | 1/78 files — hub-screen only, no in-level behavior |
| ![icon174](images/tile-full-174.png) | 174 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 12/78 files |
| ![icon175](images/tile-full-175.png) | 175 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 12/78 files |
| ![icon176](images/tile-full-176.png) | 176 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 12/78 files |
| ![icon177](images/tile-full-177.png) | 177 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 12/78 files |
| ![icon178](images/tile-full-178.png) | 178 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 9/78 files |
| ![icon179](images/tile-full-179.png) | 179 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 4/78 files |
| ![icon180](images/tile-full-180.png) | 180 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 2/78 files |
| ![icon181](images/tile-full-181.png) | 181 | (unnamed) | unnamed variant — **Billboard** (§10.2): red disc + digit on a post, numbered-marker family 174-181; exact purpose not yet identified | no | yes | 1/78 files |
| ![icon182](images/tile-full-182.png) | 182 | (unnamed) | unnamed variant — **Billboard** (§10.2): plain post/pillar; per `06-doors.md`'s `SearchDoor` this is the real door-trigger tile | no | no | 12/78 files |
...
| ![icon187](images/tile-full-187.png) | 187 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): green ventilation-grille bars | no | no | 9/78 files |
| ![icon188](images/tile-full-188.png) | 188 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): green ventilation-grille bars | no | no | 9/78 files |
| ![icon189](images/tile-full-189.png) | 189 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): green ventilation-grille bars | no | no | 10/78 files |
| ![icon190](images/tile-full-190.png) | 190 | (unnamed) | unnamed variant | no | no | 9/78 files |
| ![icon191](images/tile-full-191.png) | 191 | (unnamed) | unnamed variant — **Billboard** (§10.2): thin red post | no | no | 6/78 files |
| ![icon192](images/tile-full-192.png) | 192 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): painted door-with-hinges graphic | no | no | 11/78 files |
...
| ![icon215](images/tile-full-215.png) | 215 | (unnamed) | unnamed variant — **Billboard** (§10.2): plain sphere/orb | no | no | 13/78 files |
| ![icon216](images/tile-full-216.png) | 216 | (unnamed) | unnamed variant — **Billboard** (§10.2): plain sphere/orb | no | no | 10/78 files |
| ![icon217](images/tile-full-217.png) | 217 | (unnamed) | unnamed variant — **Billboard** (§10.2): plain sphere/orb | no | no | 14/78 files |
| ![icon218](images/tile-full-218.png) | 218 | (unnamed) | unnamed variant — **Billboard** (§10.2): colored balls/marbles on candy-striped poles | no | no | 10/78 files |
| ![icon219](images/tile-full-219.png) | 219 | (unnamed) | unnamed variant — **Billboard** (§10.2): colored balls/marbles on candy-striped poles | no | no | 6/78 files |
| ![icon220](images/tile-full-220.png) | 220 | (unnamed) | unnamed variant — **Billboard** (§10.2): colored balls/marbles on candy-striped poles | no | no | 5/78 files |
| ![icon221](images/tile-full-221.png) | 221 | (unnamed) | unnamed variant — **Billboard** (§10.2): colored balls/marbles on candy-striped poles | no | no | 4/78 files |
| ![icon222](images/tile-full-222.png) | 222 | (unnamed) | unnamed variant — **Billboard** (§10.2): colored balls/marbles on candy-striped poles | no | no | 4/78 files |
| ![icon230](images/tile-full-230.png) | 230 | (unnamed) | unnamed variant — **Billboard** (§10.2): star badge | no | no | 6/78 files |
| ![icon231](images/tile-full-231.png) | 231 | (unnamed) | unnamed variant — **Billboard** (§10.2): star badge | no | no | 7/78 files |
| ![icon233](images/tile-full-233.png) | 233 | (unnamed) | unnamed variant — **Billboard** (§10.2): mushroom/tree silhouette | no | no | 4/78 files |
| ![icon234](images/tile-full-234.png) | 234 | (unnamed) | unnamed variant — **Billboard** (§10.2): mushroom/tree silhouette | no | no | 4/78 files |
...
| ![icon253](images/tile-full-253.png) | 253 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 8/78 files |
| ![icon254](images/tile-full-254.png) | 254 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 3/78 files |
| ![icon255](images/tile-full-255.png) | 255 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 3/78 files |
| ![icon256](images/tile-full-256.png) | 256 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 2/78 files |
| ![icon257](images/tile-full-257.png) | 257 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 2/78 files |
| ![icon258](images/tile-full-258.png) | 258 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 2/78 files |
| ![icon259](images/tile-full-259.png) | 259 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 2/78 files |
| ![icon260](images/tile-full-260.png) | 260 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): blue pipe/valve/gauge-fitting family (straight run/elbow/T-junction/valve; exact sub-type per icon not resolved) | no | no | 1/78 files |
...
| ![icon264](images/tile-full-264.png) | 264 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon265](images/tile-full-265.png) | 265 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon266](images/tile-full-266.png) | 266 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 7/78 files |
| ![icon267](images/tile-full-267.png) | 267 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon268](images/tile-full-268.png) | 268 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 7/78 files |
| ![icon269](images/tile-full-269.png) | 269 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 6/78 files |
| ![icon270](images/tile-full-270.png) | 270 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon271](images/tile-full-271.png) | 271 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon272](images/tile-full-272.png) | 272 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
| ![icon273](images/tile-full-273.png) | 273 | (unnamed) | unnamed variant — **ThinMechanical** (§10.3): sparse yellow drip/goo/liquid overlay; marked `animated:no` but shape suggests an undetected animation cycle | no | yes | 8/78 files |
...
| ![icon304](images/tile-full-304.png) | 304 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball on a red spring/screw bumper | no | no | 15/78 files |
| ![icon305](images/tile-full-305.png) | 305 | `Blitz` | hazard — **ThinMechanical** (§10.3): thin jagged lightning-bolt/arc line, not bulk | tick-gated | no | 15/78 files — kills 25% of ticks |
| ![icon309](images/tile-full-309.png) | 309 | `Marker` | unclassified — **Billboard** (§10.2): small gold trophy/cup on a pedestal | no | yes | 1/78 files |
| ![icon317](images/tile-full-317.png) | 317 | `Crusher (base)` | hazard — **Billboard** (§10.2): teal segmented piston shaft on a small base, thin mechanical rod not a solid block | yes, 10 frames (317-323) | no | 3/78 files — kills Blupi on contact |
| ![icon324](images/tile-full-324.png) | 324 | `Temp (base)` | hazard/passable-timing — **ThinMechanical** (§10.3): stepped triangular/pyramid wedge, non-cuboid silhouette | yes, 20 frames, 2 blank (324-329) | no | 5/78 files — vanishes 2/20 frames |
| ![icon330](images/tile-full-330.png) | 330 | `Teleport1` | interactive — **DirectionalCube + box tip, alpha-blended** (revised 2026-07-11 twice more, supersedes the "Billboard" call below AND an intermediate "pyramid-tip" call): 4 sides show the real texture (blue background + colored indicator dots + emblem letter), top/bottom flat fallback color (solid pillar), PLUS a separate 3D box (NOT a tapering pyramid — corrected per live user feedback: the real shape is a straight-sided four-sided prism) hanging below the block using the texture's own lower ~2/3 (the cone/spike graphic). Both the cube and the tip need real alpha blending — the icon's "black" surround is genuine alpha=0 transparency, not painted black (confirmed via direct pixel/alpha-channel inspection). See plan.md E3D-MIG-147 | no | no | 11/78 files — solid pillar |
| ![icon331](images/tile-full-331.png) | 331 | `Teleport2` | interactive — **DirectionalCube + box tip, alpha-blended** (revised 2026-07-11, same as 330) | no | no | 6/78 files — solid pillar |
| ![icon332](images/tile-full-332.png) | 332 | `Teleport3` | interactive — **DirectionalCube + box tip, alpha-blended** (revised 2026-07-11, same as 330) | no | no | 4/78 files — solid pillar |
| ![icon333](images/tile-full-333.png) | 333 | `Teleport4` | interactive — **DirectionalCube + box tip, alpha-blended** (revised 2026-07-11, same as 330) | no | no | 3/78 files — solid pillar |
| ![icon334](images/tile-full-334.png) | 334 | `Door1` | interactive — **Billboard** (§10.2): red pillar/bollard shape, not a door panel; supersedes the earlier UniformCube call | no | no | 12/78 files — key-gated, see 06-doors.md |
| ![icon335](images/tile-full-335.png) | 335 | `Door2` | interactive — **Billboard** (§10.2): same red pillar/bollard family as 334, not a door panel | no | no | 10/78 files — key-gated, see 06-doors.md |
| ![icon336](images/tile-full-336.png) | 336 | `Door3` | interactive — **Billboard** (§10.2): same red pillar/bollard family as 334, not a door panel | no | no | 11/78 files — key-gated, see 06-doors.md |
...
| ![icon364](images/tile-full-364.png) | 364 | `Bridge` | interactive — **ThinMechanical** (§10.3): thin walkway/log structure — only the top 16px band is solid per `table_decor_quart` | no | no | 9/78 files — mostly solid in 2D too (only its top quarter is solid per `table_decor_quart`, `IsPassIcon(364)` returns false); solid in galaxy-eggbert. **Correction (2026-07-05, DOC-306):** an earlier version of this row claimed 364 was fully "passable in 2D" — false, see `14-crates-lifts-bridges-effects.md` for the full construction-sequence behavior (the cell does become fully hollow for most of the 157-tick build animation, but the finished/idle tile itself is not simply "passable"). |
| ![icon373](images/tile-full-373.png) | 373 | `Spike (base)` | hazard — **ThinMechanical** (§10.3): lower confidence: may just be the glossy wall-texture family, not an obviously pointed spike; flagged for a closer look | yes, 16 frames (347,373,374) | no | 5/78 files — kills Blupi on contact |
| ![icon375](images/tile-full-375.png) | 375 | (unnamed) | unnamed variant — **Billboard** (§10.2): twisted rope/banded decorative post | no | yes | 3/78 files |
...
| ![icon393](images/tile-full-393.png) | 393 | (unnamed) | unnamed variant — **architectural-kit** (§10.5): right door-jamb edge piece — likely a fragment of a modular door/archway sprite kit | no | no | 7/78 files |
| ![icon394](images/tile-full-394.png) | 394 | (unnamed) | unnamed variant — **architectural-kit** (§10.5): lintel/corner-post fragment — likely a fragment of a modular door/archway sprite kit | no | no | 7/78 files |
| ![icon395](images/tile-full-395.png) | 395 | (unnamed) | unnamed variant — **architectural-kit** (§10.5): lintel/corner-post fragment — likely a fragment of a modular door/archway sprite kit | no | no | 7/78 files |
| ![icon396](images/tile-full-396.png) | 396 | (unnamed) | unnamed variant | no | no | 7/78 files |
| ![icon397](images/tile-full-397.png) | 397 | (unnamed) | unnamed variant — **architectural-kit** (§10.5): lintel/corner-post fragment — likely a fragment of a modular door/archway sprite kit | no | no | 7/78 files |
...
| ![icon412](images/tile-full-412.png) | 412 | `Tile412` | unclassified — **Billboard** (§10.2): gold picture-frame-on-pedestal display stand | no | yes | 1/78 files |
| ![icon413](images/tile-full-413.png) | 413 | `Tile413` | unclassified — **Billboard** (§10.2): gold picture-frame-on-pedestal display stand | no | yes | 1/78 files |
| ![icon421](images/tile-full-421.png) | 421 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 10/78 files |
| ![icon422](images/tile-full-422.png) | 422 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 15/78 files |
| ![icon423](images/tile-full-423.png) | 423 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 4/78 files |
| ![icon424](images/tile-full-424.png) | 424 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 9/78 files |
| ![icon425](images/tile-full-425.png) | 425 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 4/78 files |
| ![icon426](images/tile-full-426.png) | 426 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 7/78 files |
| ![icon427](images/tile-full-427.png) | 427 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 7/78 files |
| ![icon428](images/tile-full-428.png) | 428 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 2/78 files |
| ![icon429](images/tile-full-429.png) | 429 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 2/78 files |
| ![icon430](images/tile-full-430.png) | 430 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 2/78 files |
| ![icon431](images/tile-full-431.png) | 431 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 1/78 files |
| ![icon432](images/tile-full-432.png) | 432 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 2/78 files |
| ![icon433](images/tile-full-433.png) | 433 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 1/78 files |
| ![icon434](images/tile-full-434.png) | 434 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 1/78 files |
| ![icon435](images/tile-full-435.png) | 435 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 1/78 files |
| ![icon437](images/tile-full-437.png) | 437 | (unnamed) | unnamed variant — **Billboard** (§10.2): gold ball + digit on a post, numbered-marker family 421-437; exact purpose not yet identified | no | no | 1/78 files |
