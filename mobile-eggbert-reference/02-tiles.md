...
| ![icon158](images/tile-full-158.png) | 158 | `Sp0` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 0 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon159](images/tile-full-159.png) | 159 | `Sp1` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 1 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon160](images/tile-full-160.png) | 160 | `Sp2` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 2 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon161](images/tile-full-161.png) | 161 | `Sp3` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 3 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon162](images/tile-full-162.png) | 162 | `Sp4` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 4 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon163](images/tile-full-163.png) | 163 | `Sp5` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 5 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon164](images/tile-full-164.png) | 164 | `Sp6` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 6 | no | yes | 1/78 files — named but no behavior attached yet |
| ![icon165](images/tile-full-165.png) | 165 | `Sp7` | unclassified — **Billboard** (§10.2): gold pedestal, likely `SecretPower` value 7 | no | yes | 1/78 files — named but no behavior attached yet |
...
| ![icon378](images/tile-full-378.png) | 378 | `Saw (base)` | hazard — **ThinMechanical** (§10.3): circular saw blade — thin, flat, not bulk material | yes, 6 frames (378-383) | no | 15/78 files — kills Blupi on contact; stoppable by Switch |
