...
| ![icon330](images/tile-full-330.png) | 330 | `Teleport1` | interactive — **DirectionalCube + pyramid-tip** (revised 2026-07-11, supersedes the "Billboard" call below): 4 sides show the real texture (blue background + colored indicator dots + emblem letter), top/bottom flat fallback color (solid pillar), PLUS a separate 3D pyramid-tip attachment hanging below the block using the texture's own lower ~2/3 (the cone/spike graphic) — see plan.md E3D-MIG-147 | no | no | 11/78 files — solid pillar |
| ![icon331](images/tile-full-331.png) | 331 | `Teleport2` | interactive — **DirectionalCube + pyramid-tip** (revised 2026-07-11, same as 330) | no | no | 6/78 files — solid pillar |
| ![icon332](images/tile-full-332.png) | 332 | `Teleport3` | interactive — **DirectionalCube + pyramid-tip** (revised 2026-07-11, same as 330) | no | no | 4/78 files — solid pillar |
| ![icon333](images/tile-full-333.png) | 333 | `Teleport4` | interactive — **DirectionalCube + pyramid-tip** (revised 2026-07-11, same as 330) | no | no | 3/78 files — solid pillar |
