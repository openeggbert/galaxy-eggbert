...
namespace
{
    ...
    void checkSequence(GalaxyEggbert::Def::ObjectType type, int divisor, const std::vector<int>& sequence, const std::string& name)
    {
    ...
    void checkAscending(GalaxyEggbert::Def::ObjectType type, int divisor, int base, int period, const std::string& name)
    {
        for (int p = 0; p < divisor * period * 2; ++p)
        {
    ...
    void checkStatic(GalaxyEggbert::Def::ObjectType type, int expectedIcon, const std::string& name)
    {
...
int main()
{
    ...
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType23, 176, "ObjectType23 (secret-level marker) static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType28, 167, "ObjectType28 static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType29, 177, "ObjectType29 static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType56, 253, "ObjectType56 static icon (100 real frames would overflow the sheet)");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType52, 365, "ObjectType52 static icon (157 real frames would overflow the sheet)");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType1, 29, "ObjectType1 (platform lift) static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType12, 32, "ObjectType12 (crate) static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType13, 68, "ObjectType13 static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType30, 178, "ObjectType30 static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType19, 89, "ObjectType19 (jeep) static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType46, 208, "ObjectType46 (Overcraft) static icon");
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType55, 252, "ObjectType55 (dynamite) static icon");
    ...
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType2, 2, 12, 9, "ObjectType2 (patrol enemy A)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType3, 2, 48, 9, "ObjectType3 (patrol enemy B)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType36, 2, 179, 8, "ObjectType36 (pollution puff)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType41, 2, 179, 8, "ObjectType41 (invert-start burst)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType31, 2, 238, 6, "ObjectType31 (charge power-up)");
    // ObjectType16: 9 frames, matches 08-animations.md §3.1 ("spider", 9 frames).
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType16, 1, 69, 9, "ObjectType16 (spider)");
    // ObjectType6/7: 8 frames each, matches 08-animations.md §3.1 ("egg"/"exit goal", 8 frames).
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType6, 4, 21, 8, "ObjectType6 (extra-life egg)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType7, 3, 29, 8, "ObjectType7 (level-exit goal)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType98, 1, 90, 10, "ObjectType98 (bullet-splat, table_sploutch1)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType200, 1, 257, 6, "ObjectType200 (Blupi-skin)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType201, 1, 257, 6, "ObjectType201 (Blupi-skin)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType202, 1, 257, 6, "ObjectType202 (Blupi-skin)");
    checkAscending(GalaxyEggbert::Def::ObjectType::ObjectType203, 1, 257, 6, "ObjectType203 (Blupi-skin)");
    ...
    // ObjectType42: descending range (186 down to 179).
    {
        ...
        for (int p = 0; p < kDivisor * kPeriod * 2; ++p)
        {
            ...
            check(GetObjIcon(GalaxyEggbert::Def::ObjectType::ObjectType42, p) == expected,
    ...
    // period 22 -- matches 08-animations.md §3.1 ("treasure sparkle", "22 (11-icon ping-pong)").
    {
        ...
        for (int p = 0; p < kDivisor * kPeriod * 2; ++p)
        {
            ...
            check(GetObjIcon(GalaxyEggbert::Def::ObjectType::ObjectType5, p) == expected,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType34, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType37, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType39, 1, {166, 165, 164, 163, 162, 161, 162, 163, 164, 165, 166},
                  "ObjectType39 (kTresorTrack, real table_tresortrack)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType57, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType97, 1, {256, 258, 260, 262, 264},
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType15, 2,
                  {103, 104, 105, 106, 104, 103, 106, 105, 103, 104, 103, 105, 106, 103, 105, 106,
                   103, 104, 106, 105},
                  "ObjectType15 (kBlup)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType35, 2, {244, 99, 244}, "ObjectType35 (kTiplouf)");
    // ObjectType4/17/20/33: 8 frames each, matches 08-animations.md §3.1.
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType4, 9, {66, 66, 67, 67, 66, 66, 65, 65},
                  "ObjectType4 (kBulldozer, generic phase-indexed fallback)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType17, 6, {82, 82, 81, 81, 82, 82, 83, 83},
                  "ObjectType17 (kFish, generic phase-indexed fallback)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType20, 6, {98, 99, 100, 101, 102, 103, 104, 105},
                  "ObjectType20 (kBird, generic phase-indexed fallback)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType33, 6, {249, 249, 250, 250, 249, 249, 248, 248},
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType49, 3, {209, 210, 211, 212, 213, 214, 215, 214, 213, 212, 211, 210},
                  "ObjectType49 (kCle1, Key1)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType50, 3, {220, 221, 222, 221, 220, 219, 218, 217, 216, 217, 218, 219},
                  "ObjectType50 (kCle2, Key2)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType51, 3, {229, 228, 227, 226, 225, 224, 223, 224, 225, 226, 227, 228},
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType25, 2,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType21, 3, {122, 123, 124, 125, 126, 127, 128, 127, 126, 125, 124, 123},
                  "ObjectType21 (kCleGeneric)");
    // ObjectType24: 34 frames, matches 08-animations.md §3.2 ("skateboard", 34 frames).
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType24, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType26, 2, {136, 137, 138, 139, 140, 141, 142, 143}, "ObjectType26 (kPower)");
    // ObjectType40: 20 frames, matches 08-animations.md §3.2 ("mirror/invert", 20 frames).
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType40, 2,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType47, 1, {311, 312, 313, 314, 315, 316}, "ObjectType47 (kChenille)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType48, 1, {316, 315, 314, 313, 312, 311}, "ObjectType48 (kChenillei, reverse)");
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType32, 6, {66, 67, 68, 67, 66, 69, 70, 69},
                  "ObjectType32 (kBlupihLeft, generic phase-indexed fallback)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType44, 6, {195, 196, 197, 198, 197, 196},
                  "ObjectType44 (kGuepeLeft, generic phase-indexed fallback; matches 08-animations.md's \"6 frames\")");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType54, 6, {247, 248, 249, 250, 251, 250, 249, 248},
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType96, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType8, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType9, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType10, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType11, 1, {12, 13, 14, 15, 7, 8, 9, 10, 11},
                  "ObjectType11 (kExplo4, real table_explo4, 9 frames per 08-animations.md §4)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType90, 1, {54, -1, 55, -1, 56, -1, 57, -1, 58, -1, 59, -1},
                  "ObjectType90 (kExplo5, real table_explo5, 12 frames per 08-animations.md §4)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType91, 1, {54, 55, 56, 57, 58, 59},
                  "ObjectType91 (kExplo6, real table_explo6, 6 frames per 08-animations.md §4)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType93, 1, {7, 8, 9, 10, 11},
                  "ObjectType93 (kExplo8, real table_explo8, 5 frames per 08-animations.md §4)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType99, 1, {-1, -1, -1, 90, 91, 92, 93, 94, 95, 96, 97, 98, 99},
                  "ObjectType99 (kSploutch2, real table_sploutch2, real leading -1 delay)");
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType100, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType53, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType92, 1,
    ...
    checkSequence(GalaxyEggbert::Def::ObjectType::ObjectType38, 1,
    ...
    checkStatic(GalaxyEggbert::Def::ObjectType::ObjectType58, 0, "ObjectType58 (no real icon -- confirmed gap, not a bug)");
    ...
    // only meaningful for types already on the blupi-png path).
    {
        ...
        check(IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType14) && IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType15) &&
                  IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType31) && IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType35) &&
                  IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType52),
              "IsObjectMPngSourced() matches its real membership list (14/15/31/35/52)");
        check(IsExploPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType8) && IsExploPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType53) &&
                  IsExploPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType100),
              "IsExploPngSourced() matches its real membership list (spot-checked: 8/53/100)");
        check(IsBlupiPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType200) && IsBlupiPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType38),
              "IsBlupiPngSourced() matches its real membership list (spot-checked: 200/38)");
        check(!IsUniformCubeObject(GalaxyEggbert::Def::ObjectType::ObjectType6) && !IsObjectMPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType6) &&
                  !IsExploPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType6) && !IsBlupiPngSourced(GalaxyEggbert::Def::ObjectType::ObjectType6),
              "the extra-life egg (ObjectType6) is on none of the 4 special sheets -- falls to element.png");

        // Exhaustive mutual-exclusivity check across GalaxyEggbert::Def::ObjectType's full
        ...
        for (int i = 0; i <= 255; ++i)
        {
            const GalaxyEggbert::Def::ObjectType t = GalaxyEggbert::Def::ToObjectType(i);
        ...
        check(exclusive, "the 4 texture-sheet predicates are mutually exclusive across every GalaxyEggbert::Def::ObjectType (0-255)" +
