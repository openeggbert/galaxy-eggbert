...
namespace GalaxyEggbert::CNA
{
    ...
    // grabbable bar/rope tile (plan.md TILE-045, GEBlupiController's
    ...
    // GEInnerPillarBoxTiles' icon 384/385 defaulting to PosZ). The 2 blue
    // end caps use the same GESwatchUv "sample the icon's own texture"
