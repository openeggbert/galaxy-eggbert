...
namespace GalaxyEggbert::CNA
{
    ...
    // GEInnerFlatPlateTiles.hpp's GetInnerFlatPlateAxis()) rather than a
    ...
    // GEBlupiController/GEWorldRuntime's own established precedent for
    ...
    // set to true -- callers (GETerrainRenderer) collect this ONCE and
