...
namespace GalaxyEggbert::CNA
{
    ...
    // alpha -- see GETerrainRenderer's NeedsAlphaBlend), icon 107 (top=false
    // here on purpose -- its actual grass top texture is rendered separately
    // by GETerrainRenderer's IsGrassTopIcon()/m_grassRenderer, not this
    ...
    //
    // @p icon107Uv is icon 107's own tile UV (GETileAtlas::GetTileUv(107)),
