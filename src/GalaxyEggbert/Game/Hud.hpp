...
namespace GalaxyEggbert::Game
{
    ...
    public:
        ...
        // panel width. Pass nullptr for no hint this frame (TrainingHints
        ...
        // caller interpolates via InteractionSystem::VoyageDrawX/Y()).
        ...
        // site (`mission != 1 && mission % 10 != 0`), since Hud itself
