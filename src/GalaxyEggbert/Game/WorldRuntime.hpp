...
namespace GalaxyEggbert::Game
{
    ...
    struct MobileObjSpec
    {
        ...
        // advanced by WorldRuntime::Update() at mobile-eggbert's original
        ...
        // InteractionSystem). current{X,Y,Z} start equal to posStart and
        ...
        // `Decor::MoveObjectStepLine` -- see InteractionSystem.cpp's
        ...
        // patrol in InteractionSystem -- these fields are only consumed
    ...
    public:
        ...
        // TerrainRenderer::AnimIcon() now divides this raw tick by each
        ...
        // (channel 77 "on"/76 "off") -- this method has no `Sound&`
        // parameter, same separation as `InteractionSystem`'s `LoseLife()`.
        ...
        // pillar's own cell -- see `BlupiController::GetBlockTypeAbove()`'s
        ...
        // frame number; TerrainRenderer::AnimIcon() divides it by each
        ...
        // `BlupiController::Step()`'s `tempPassable` parameter, not by
